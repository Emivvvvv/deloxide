...
freed or retained; see the [C callback notes](c-guide.md#initialize-once-then-keep-callbacks-small).
...
use the manual registration pattern in the [C Guide](c-guide.md#threads-and-posix-helpers).
